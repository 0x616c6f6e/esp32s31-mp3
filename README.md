...
- [双面元件摆放 / 手动布线版](hardware-q2-placement/README.md)：打开 `hardware-q2-placement/hardware.kicad_pro`；已恢复 125 个封装的原理图关联，正面 59 个、背面 62 个实体元件；按 USB、音频和电源功能优化摆放，保留网络供手动布线。
...
- [FreeCAD 外壳 F](mechanical/enclosure-q2-f/README.md)：屏幕盖板上、左、右边距均为 2 mm，操作区上移 2 mm。外壳设计源文件为 `mechanical/enclosure-q2-f/ESP32S31_MP3_Q2_F.FCStd`；最新 PCB 摆放与 F 外壳的检查装配为 `hardware-q2-placement/output/placement-F-fit.FCStd`。
