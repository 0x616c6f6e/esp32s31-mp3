...
assert h==a['pcb_sha256']
assert m['pcb_source_sha256']==f['pcb_source_sha256']
from verify_3d_models import verify_mechanical_baseline
verify_mechanical_baseline(ROOT,f['pcb_source_sha256'])
...
r.update(mechanical_source_pcb_sha256=f['pcb_source_sha256'],mechanical_checks_scope='Frozen approximate E envelopes; newly attached component STEP models not included in those checks',component_step_models_interference_validated=False)
