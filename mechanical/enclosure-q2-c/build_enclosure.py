...
DOCNAME='Q2_Enclosure_C'
if any(n in App.listDocuments() for n in [DOCNAME,'ESP32S31_MP3_Q2_C']):
    raise RuntimeError('The enclosure document is already open. Save/close it before rebuilding.')
doc=App.newDocument(DOCNAME)
doc.Label='ESP32-S31 MP3 / Q2 C / corrected mainboard orientation + control daughterboard'
