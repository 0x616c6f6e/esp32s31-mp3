...
phys += [d.RearInsertTop,d.RearInsertBottom,d.LCDMountTape,d.MotorCarrierAdhesive,d.LensAdhesive]
...
for i,a in enumerate(phys):
 ...
 for b in phys[i+1:]:
  ...
  if n in [{'PCB_FPC1','ControlFFC40mm'},{'CTRL_J1','ControlFFC40mm'},{'PCB_FPC2','DisplayFPCRoute'},{'MainBoardFasteners','RearCoverWithPCBPosts'},{'ControlBoardFasteners','HousingControlsA'}]:continue
