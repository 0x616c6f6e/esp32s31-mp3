...
fixed=[d.MotorCarrier,d.HousingControlsA,d.ControlsBoard,d.WheelControlsA,d.CenterButtonControlsA,d.Motor_C08_005,d.LCDModule,d.RearInsertTop,d.RearInsertBottom,d.ControlBoardFasteners,d.ControlWashers,d.ControlEdgePad,d.BatteryPack]+[o for o in d.Electronics.Group if o.Name.startswith('CTRL_')]
