...
doc.saveAs(str(HERE/'ESP32S31_MP3_Q2_D.FCStd'))
for obj,stem in [(housing,'q2-d-housing'),(rear,'q2-d-rear-cover'),(wheel,'q2-d-wheel-rocker'),(button,'q2-d-center-button'),(control,'control-board-mechanical')]:
...
Part.makeCompound([o.Shape for o in newphysical+[doc.MainPCB,doc.MainComponents,fpc,controlfpc,fpc2]]).exportStep(str(OUT/'assembly-D-current-PCB-CONFLICTS.step'))
...
print('ASSEMBLY_D_COMPLETE',json.dumps(checks,ensure_ascii=False))
