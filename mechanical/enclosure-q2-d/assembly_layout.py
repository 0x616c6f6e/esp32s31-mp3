...
fpc2_shape=Part.makeBox(3.2,7.9,1.0,V(7.652,14.084,main_z-1.0))
...
fpc=ref('DisplayFPCRoute','屏幕 FPC / 上移1.5 mm后的自然轴线，尚未插接',Part.makeCompound(routeparts),(.9,.55,.16),'Centerline46.14 mm; no lateral shear. Natural axisY20.400 vs socketY18.034, mismatch2.366. R0.65/R0.675 and tip X/Z are assumptions; not mated or fabrication-ready.')
...
fpc.addProperty('App::PropertyString','Connection','Routing').Connection='LCD front -> LEFT edge wrap -> rear loop; UNMATED, Y offset2.366 mm'
