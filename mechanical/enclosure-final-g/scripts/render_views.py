...
d=A.openDocument(str(O/'Q2_G_Thin_Assembly.FCStd'))
...
def phase4():
 ...
 (O/'views-ready.txt').write_text('Three views rendered; assembly placements restored.')
...
def guard(fn):
 ...
 return run
for name in ['phase1','phase2','phase3','phase4']:globals()[name]=guard(globals()[name])
