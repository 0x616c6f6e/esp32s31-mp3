...
def phase6():
 ...
 (O/'views-ready.txt').write_text('Five views rendered; assembly placements restored.')
...
def guard(fn):
 ...
 return run
for name in ['phase1','phase2','phase3','phase4','phase5','phase6']:globals()[name]=guard(globals()[name])
