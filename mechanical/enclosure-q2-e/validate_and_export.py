"""Assembly-level checks using the actual revision-E PCB and component envelopes."""
doc.recompute()
...
doc.saveAs(str(HERE/'ESP32S31_MP3_Q2_E.FCStd'))
for obj,stem in [(housing,'q2-e-housing'),(rear,'q2-e-rear-cover'),(wheel,'q2-e-wheel-rocker'),(button,'q2-e-center-button'),(control,'control-board-mechanical')]:
...
Part.makeCompound([o.Shape for o in newphysical+[doc.MainPCB,doc.MainComponents,fpc,controlfpc,fpc2]]).exportStep(str(OUT/'assembly-E-new-PCB.step'))
...
print('ASSEMBLY_E_COMPLETE',json.dumps(checks,ensure_ascii=False))
