...
show(external);save(camera((-1,1,1.8)),'exterior-E.png')
v=Gui.activeDocument().activeView();v.setCameraOrientation(App.Rotation(App.Vector(0,0,1),180).Q);settle();v.fitAll();settle();save(v,'front-E.png',1000,1500)
show(external+['MainPCB','MainComponents','ESP32Front','ScreenConnectorFPC2','LCDModule','DisplayFPCRoute','ControlBoard','ControlFPCConnector','BatteryReference'])
...
doc.ReviewStatus='Screen raised1.5 mm; actual46x76R10 PCB. See validation.json for interference results. Component heights partly assumed; LCD mating slot/pinout and control-board electronics remain unverified.'
doc.recompute();doc.save()
print('E_VIEWS_COMPLETE')
